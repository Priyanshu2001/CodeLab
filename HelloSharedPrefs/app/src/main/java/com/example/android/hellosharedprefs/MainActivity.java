...
public class MainActivity extends AppCompatActivity {
    ...
    private  String sharedpPrefFile="com.example.android.hellosharedprefs";
    // Current count
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPrefences = getSharedPreferences(sharedpPrefFile, MODE_PRIVATE);

        // Restore the saved instance state.
         mCount= mPrefences.getInt(COUNT_KEY,0);
         mShowCountTextView.setText(String.format("%s",mCount));
         mColor = mPrefences.getInt(COLOR_KEY,mColor);
    ...
    protected void onPause() {
        super.onPause();
        mPrefences.edit().putInt(COUNT_KEY,mCount)
